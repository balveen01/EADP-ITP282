...
{
    public partial class View_Deactivated : System.Web.UI.Page
    {
        ...
        {
            gv_Staff.DataSource = staff.getAllDeactivatedStaff();
            gv_Staff.DataBind();
        }
        ...
        {
            gv_Staff.DataSource = staff.getAllDeactivatedStaff(tb_Search.Text);
            gv_Staff.DataBind();
        }
