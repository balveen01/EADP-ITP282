<%@ Page Title="" Language="C#" MasterPageFile="~/assets/mp/CatalogueMaster.master" AutoEventWireup="true" CodeBehind="ArcCat.aspx.cs" Inherits="Triangle.w.Admin.Catalogue.ArcCat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
    <style>
        #BodyPlaceHolder_BodyPlaceHolder_SideNavPlaceHolder_lbtn_cat_Archived {
            color: #007bff;
        }
    </style>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    <div class="row no-gutters justify-content-center mt-4">
        ...
        <div class="col-md-12">
            ...
            <asp:GridView ID="gv_category" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="type_id" OnPageIndexChanging="gv_category_PageIndexChanging" PageSize="10" CssClass="table table-striped table-bordered">
                <Columns>
