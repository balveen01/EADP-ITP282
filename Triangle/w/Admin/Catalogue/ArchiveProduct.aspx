<%@ Page Title="" Language="C#" MasterPageFile="~/assets/mp/CatalogueMaster.master" AutoEventWireup="true" CodeBehind="ArchiveProduct.aspx.cs" Inherits="Triangle.w.Admin.Catalogue.ArchiveProduct" %>
    ...
    <style>
        ...
        table {
            ...
            table tr td {
                ...
                table tr td:nth-child(1), table tr td:nth-child(6) {
                    width: 10%;
                }
    </style>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    <div class="row no-gutters justify-content-center mt-4">
        ...
        <div class="col-md-12">
            ...
            <asp:GridView ID="gv_products" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="product_id" OnPageIndexChanging="gv_products_PageIndexChanging" PageSize="10" CssClass="table table-striped table-bordered" OnRowDeleting="gv_products_RowDeleting">
                <Columns>
