...
{
    public partial class ArcCat : System.Web.UI.Page
    {
        ...
        protected void gv_category_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (result > 0)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(),"alert","alert('Category has been unarchived successfully');window.location ='ArcCat.aspx';",true);
