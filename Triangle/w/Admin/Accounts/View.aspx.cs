...
namespace Triangle.w.Admin.Accounts
{
    public partial class View : System.Web.UI.Page
    {
        ...
        protected void LoadAccounts()
        {
            try
            {
                ...
                if (query == "a")
                {
                    ...
                    gv_Accounts.DataSource = Accounts.GetAllUsers("admin");
                }
                else
                {
                    ddl_Filter.SelectedValue = "customer";
                    gv_Accounts.DataSource = Accounts.GetAllUsers("customer");
                }
            }
            catch
            {
                Response.Redirect("View.aspx?q=c");
            }
        ...
        protected void ddl_Filter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("View.aspx?q=a");
            }
