...
public class ShoppingCart
{
    ...
    static ShoppingCart()
    {
        if (HttpContext.Current.Session["TriangleShoppingCart"] == null)
        {
            Instance = new ShoppingCart();
            Instance.Items = new List<ShoppingCartItem>();
            HttpContext.Current.Session["TriangleShoppingCart"] = Instance;
        }
        else
        {
    ...
    {
        //ShoppingCartItem newItem = new ShoppingCartItem(ProductID);
        ShoppingCartItem newItem = new ShoppingCartItem(bundleid, bund, totalprice);
