...
namespace Triangle.models
{
    public class Category
    {
        ...
        public List<Category> getCategoryAll()
        {
            ...
            string queryStr = "SELECT * FROM product_type where is_archived = 'False' Order by type_id";
            SqlConnection conn = new SqlConnection(_connStr);
            SqlCommand cmd = new SqlCommand(queryStr, conn);
            conn.Open();
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        public int CategoryInsert(string name, string desc, int history)
        {
            ...
            string queryStr = "INSERT INTO product_type (type_name, type_desc, update_history_id) values (@type_name, @type_desc, @history)";
        ...
        public int UpdateCategory(int type_id, string type_name, string type_desc)
        {
        ...
        public List<Category> checkcat(string tid)
        {
            List<Category> checkcatlist = new List<Category>();

            string type_name, type_desc;
            int type_id, update_history_id;
            bool is_archived;

            string queryStr = "SELECT * FROM product_type where type_name = @id";
            SqlConnection conn = new SqlConnection(_connStr);
            SqlCommand cmd = new SqlCommand(queryStr, conn);
            cmd.Parameters.AddWithValue("@id", tid);
            conn.Open();
